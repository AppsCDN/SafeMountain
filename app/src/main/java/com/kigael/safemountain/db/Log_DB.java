...
public final class Log_DB {
    private Log_DB() {}
    public static final String SQL_CREATE_ALL_TABLE = String.format("create table if not exists %s (%s integer PRIMARY KEY , %s text)",
            All_DB_Entry.TABLE_NAME,
            All_DB_Entry.COLUMN_NAME_ID,
            All_DB_Entry.COLUMN_NAME_PATH);
    public static class All_DB_Entry implements BaseColumns {
